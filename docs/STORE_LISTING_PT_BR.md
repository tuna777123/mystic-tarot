...
Estes textos estão prontos para serem inseridos diretamente nas localizações em português do Brasil do App Store Connect e do Google Play Console.
...
**Subtítulo (máximo de 30 caracteres)**  
...
https://tuna777123.github.io/mystic-tarot/privacy-pt-br.html
...
**Nome do app (máximo de 30 caracteres)**  
Mystic Tarot: Ritual Diário
...
- Mystic Intelligence continua criando no dispositivo um relatório privado de sete dias a partir de leituras salvas e check-ins do Mystic Mirror concluídos.
