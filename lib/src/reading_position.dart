  ...
  List<String> positionsFor(ReadingKind value) => switch (value) {
    ...
    ReadingKind.celticCross => <String>[
      copy(
        ...
        tr: 'Mevcut durum',
        es: 'Situación presente',
        fr: 'Situation présente',
        pt: 'Situação presente',
      ),
      copy(
        en: 'Immediate challenge',
        tr: 'Yakın meydan okuma',
        es: 'Desafío inmediato',
        fr: 'Défi immédiat',
        pt: 'Desafio imediato',
      ),
      copy(
        en: 'Foundation beneath the issue',
        tr: 'Konunun altındaki temel',
        es: 'Base del asunto',
        fr: 'Fondation du sujet',
        pt: 'Base da questão',
      ),
      copy(
        en: 'Recent past influence',
        tr: 'Yakın geçmiş etkisi',
        es: 'Influencia del pasado reciente',
        fr: 'Influence du passé récent',
        pt: 'Influência do passado recente',
      ),
      copy(
        en: 'Conscious possibility',
        tr: 'Bilinçli ihtimal',
        es: 'Posibilidad consciente',
        fr: 'Possibilité consciente',
        pt: 'Possibilidade consciente',
      ),
      copy(
        en: 'Near-future movement',
        tr: 'Yakın gelecek hareketi',
        es: 'Movimiento del futuro cercano',
        fr: 'Mouvement du futur proche',
        pt: 'Movimento do futuro próximo',
      ),
      copy(
        en: 'Your inner stance',
        tr: 'İç tutumun',
        es: 'Tu postura interior',
        fr: 'Votre posture intérieure',
        pt: 'Sua postura interior',
      ),
      copy(
        en: 'External environment',
        tr: 'Dış çevre',
        es: 'Entorno externo',
        fr: 'Environnement extérieur',
        pt: 'Ambiente externo',
      ),
      copy(
        en: 'Hopes and fears',
        tr: 'Umutlar ve korkular',
        es: 'Esperanzas y temores',
        fr: 'Espoirs et craintes',
        pt: 'Esperanças e medos',
      ),
      copy(
        en: 'Direction if the pattern continues',
        tr: 'Örüntü sürerse yön',
        es: 'Dirección si continúa el patrón',
        fr: 'Direction si le schéma continue',
        pt: 'Direção se o padrão continuar',
      ),
    ],
  };
