...
class _PremiumScreenState extends State<PremiumScreen> {
      ...
      child: ListView(
        ...
        children: [
              ...
              child: Row(
                children: [
                  const CircleAvatar(
                    radius: 11,
                    backgroundColor: MysticColors.gold,
                    child: Icon(Icons.check, size: 14, color: MysticColors.ink),
                  ),
                  const SizedBox(width: 11),
                  Expanded(
                    child: Text(
          ...
          GoldButton(
            ...
            icon: kIsWeb ? Icons.phone_iphone_rounded : Icons.lock_open_rounded,
          ),
          const SizedBox(height: 10),
          Text(
            kIsWeb
  ...
  void _openLegal(String title) => Navigator.push(
    context,
    ...
    return Scaffold(
      ...
      body: MysticBackground(
        child: ListView(
          ...
          children: [
            Text(
              privacy ? 'Privacy, in plain language' : 'A fair mystical space',
              style: Theme.of(context).textTheme.headlineMedium,
            ),
            const SizedBox(height: 12),
            Text(
