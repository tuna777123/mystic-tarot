...
class MysticTextCatalog {
  ...
  static const Set<String> launchLanguageCodes =
      full.MysticTextCatalog.launchLanguageCodes;
  ...
  static String translate(String languageCode, String english) {
    if (languageCode == 'FR') {
      ...
      if (english.endsWith(' LOCKED')) {
        return '${english.substring(0, english.length - 7)} FERMÉES';
      }
      if (english.startsWith('Unlock the full ')) {
        return 'Débloquer ce tirage';
      }
    }
  ...
  static const Map<String, String> _compactFrench = <String, String>{
    ...
    'The first signal is forming…': 'Le signe apparaît…',
    'The rest of your spread': 'Suite du tirage',
  };
}
